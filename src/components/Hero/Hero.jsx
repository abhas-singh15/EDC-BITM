            ...
            <div className='flex md:flex-row flex-col'>
               <div>
                  <div className='w-full hero-2'>
                     ...
                     <h3 className='text-start text-base mb-4 mr-16'>With a team of dedicated experts and passionate empowering entrepreneurs, we bring a wealth of experience and knowledge to every proposal. Our expertise helps to enhance one's fostered growth and supports each entrepreneurial journey.</h3>
                  </div>
                  <ScrollTrigger onEnter={() => setCounterOn(true)} onExit={() => setCounterOn(false)}>
                     <div className='w-full h-1/2 flex mt-2 mb-10 flex-col gap-8'>
                        <div className='flex items-center md:justify-start justify-center pt-5 pl-20 md:gap-40 hero-3'>
                        ...
                        <div className='flex md:gap-40 hero-3 items-center md:justify-start justify-center pl-20 text-xl font-semibold'>
